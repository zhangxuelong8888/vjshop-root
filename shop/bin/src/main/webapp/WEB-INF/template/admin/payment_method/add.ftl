...
<title>${message("admin.paymentMethod.add")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.paymentMethod.add")}
	</div>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<select name="type">
						[#list types as type]
							<option value="${type.ordinal()}">${message("PaymentMethod.Type." + type)}</option>
						[/#list]
					</select>
				</td>
			</tr>
				...
				<td>
					<select name="method">
						[#list methods as method]
							<option value="${method.ordinal()}">${message("PaymentMethod.Method." + method)}</option>
						[/#list]
					</select>
				</td>
			</tr>
