...
<title>${message("admin.navigation.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.navigation.list")}
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list topNavigations as navigation]
				<tr>
					...
					<td>
						${message("Navigation.Position." + navigation.enumPosition)}
					</td>
					<td>
