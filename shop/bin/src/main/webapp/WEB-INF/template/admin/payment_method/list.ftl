...
<title>${message("admin.paymentMethod.list")} - Powered By VJSHOP</title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as paymentMethod]
				<tr>
					...
					<td>
						${message("PaymentMethod.Type." + paymentMethod.typeName())}
					</td>
					<td>
						${message("PaymentMethod.Method." + paymentMethod.methodName())}
					</td>
					<td>
