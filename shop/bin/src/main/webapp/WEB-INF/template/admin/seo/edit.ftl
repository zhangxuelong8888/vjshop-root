...
<title>${message("admin.seo.edit")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.seo.edit")}
	</div>
			...
			<tr>
				...
				<td>
					...
					<div class="tag">
						...
						[#elseif seo.enumType == "goodsList"]
							<a href="javascript:;" val="[#noparse]${productCategory.name}[/#noparse]">${message("admin.seo.productCategoryName")}</a>
						[#elseif seo.enumType == "goodsSearch"]
							<a href="javascript:;" val="[#noparse]${goodsKeyword}[/#noparse]">${message("admin.seo.goodsKeyword")}</a>
						[#elseif seo.enumType == "goodsContent"]
							<a href="javascript:;" val="[#noparse]${goods.sn}[/#noparse]">${message("admin.seo.goodsSn")}</a>
							<a href="javascript:;" val="[#noparse]${goods.name}[/#noparse]">${message("admin.seo.goodsName")}</a>
							<a href="javascript:;" val="[#noparse]${goods.productCategory.name}[/#noparse]">${message("admin.seo.goodsProductCategoryName")}</a>
						[#elseif seo.enumType == "brandContent"]
