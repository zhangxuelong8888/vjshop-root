...
<title>${message("admin.freightConfig.add")} - Powered By VJSHOP</title>
	...
	$inputForm.validate({
		rules: {
			areaId: {
				required: true,
				remote: {
					url: "check_area.jhtml?shippingMethodId=${shippingMethod.id}",
					cache: false
				}
			},
			firstPrice: {
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.freightConfig.add")}
	</div>
