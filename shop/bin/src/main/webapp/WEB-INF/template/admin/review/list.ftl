...
<title>${message("admin.review.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.review.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as review]
				<tr>
					...
					<td>
						<a href="${review.goodsInfo.url}" title="${review.goodsInfo.name}" target="_blank">${abbreviate(review.goodsInfo.name, 50, "...")}</a>
					</td>
					<td>
						${review.score}
					</td>
