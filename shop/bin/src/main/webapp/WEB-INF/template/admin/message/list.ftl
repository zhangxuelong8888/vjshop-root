...
<title>${message("admin.message.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.message.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
					...
					<td>
						[#if !adminMessage.receiver??]
							<a href="${base}/admin/member/view.jhtml?id=${adminMessage.senders.id}">
								${adminMessage.senders.username}
							</a>
						[#else]
							<a href="${base}/admin/member/view.jhtml?id=${adminMessage.receivers.id}">
								${adminMessage.receivers.username}
							</a>
						[/#if]
					</td>
					<td>
