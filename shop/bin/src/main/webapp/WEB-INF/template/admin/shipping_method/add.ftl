...
<title>${message("admin.shippingMethod.add")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="defaultFirstPrice" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="defaultContinuePrice" class="text" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
