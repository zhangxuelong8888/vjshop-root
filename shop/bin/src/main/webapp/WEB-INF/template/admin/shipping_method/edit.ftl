...
<title>${message("admin.shippingMethod.edit")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
				...
				<td>
					<select name="defaultDeliveryCorpId">
						...
						[#list deliveryCorps as deliveryCorp]
							<option value="${deliveryCorp.id}"[#if deliveryCorp.id == shippingMethod.defaultDeliveryCorp] selected="selected"[/#if]>
								${deliveryCorp.name}
							</option>
						[/#list]
					</select>
			...
			<tr>
				...
				<td>
					<input type="text" name="defaultFirstPrice" class="text" value="${shippingMethod.defaultFirstPrice}" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="defaultContinuePrice" class="text" value="${shippingMethod.defaultContinuePrice}" maxlength="16" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${shippingMethod.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
