...
<title>${message("admin.index.title")} - Powered By VJSHOP</title>
...
<body>
	...
	<table class="input">
		<tr>
			...
			<td>
				${systemName}
				<a href="http://www.vjshop.com" class="silver" target="_blank">[${message("admin.index.license")}]</a>
			</td>
			<th>
		...
		<tr>
			...
			<td>
				<a href="http://www.vjshop.com" target="_blank">http://www.vjshop.com</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.vjshop.com" target="_blank">http://bbs.vjshop.com</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td class="powered" colspan="4">
				COPYRIGHT © 2005-2018 vjshop.com ALL RIGHTS RESERVED.
			</td>
		</tr>
	</table>
</body>
