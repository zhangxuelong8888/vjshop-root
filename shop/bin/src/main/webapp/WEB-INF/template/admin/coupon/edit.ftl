...
<title>${message("admin.coupon.edit")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<div class="tabContent">
			<table class="input">
				<tr>
					<td>
						<textarea id="introduction" name="introduction" class="editor" style="width: 100%;">${coupon.introduction}</textarea>
					</td>
				</tr>
			</table>
		</div>
