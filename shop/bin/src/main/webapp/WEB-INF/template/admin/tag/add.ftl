...
<title>${message("admin.tag.add")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.tag.add")}
	</div>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<select name="type">
						[#list types as type]
							<option value="${type.ordinal()}">${message("Tag.Type." + type)}</option>
						[/#list]
					</select>
				</td>
			</tr>
