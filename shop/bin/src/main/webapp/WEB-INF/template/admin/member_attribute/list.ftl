...
<title>${message("admin.memberAttribute.list")} - Powered By VJSHOP</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			...
			[#list page.content as memberAttribute]
				<tr>
					<td>
						<input type="checkbox" name="ids"[#if memberAttribute.enumType == "text" || memberAttribute.enumType == "select" || memberAttribute.enumType == "checkbox"] value="${memberAttribute.id}"[#else] title="${message("admin.memberAttribute.deleteSystemNotAllowed")}" disabled="disabled"[/#if] />
					</td>
					<td>
