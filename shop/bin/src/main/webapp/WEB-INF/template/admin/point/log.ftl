...
<title>${message("admin.point.log")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.point.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="log.jhtml" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "memberInfo.username"] class="current"[/#if] val="memberInfo.username">${message("PointLog.member")}</li>
					<li[#if page.searchProperty == "operator"] class="current"[/#if] val="operator">${message("PointLog.operator")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="operator">${message("PointLog.operator")}</a>
				</th>
				<th>
			...
			[#list page.content as pointLog]
				<tr>
					<td>
						${message("PointLog.Type." + pointLog.enumType)}
					</td>
					<td>
						${pointLog.credit}
					</td>
					...
					<td>
						[#if pointLog.memberInfo??]
							<a href="../member/view.jhtml?id=${pointLog.memberInfo.id}">${pointLog.memberInfo.username}</a>
						[#else]
							-
						[/#if]
					</td>
