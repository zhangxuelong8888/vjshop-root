...
<title>${message("admin.article.edit")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.article.edit")}
	</div>
				...
				<td>
					<select name="articleCategoryId">
						[#list articleCategoryTree as articleCategory]
							<option value="${articleCategory.id}"[#if articleCategory == article.category] selected="selected"[/#if]>
