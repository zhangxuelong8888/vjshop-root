...
<title>${message("shop.member.receiver.edit")}[#if showPowered] - Powered By VJSHOP[/#if]</title>
					...
					<form id="inputForm" action="update.jhtml" method="post">
						...
						<table class="input">
							...
							<tr>
								...
								<td>
									<span class="fieldSet">
										<input type="hidden" id="areaId" name="areaId" value="${(receiver.areaVO.id)!}" treePath="${(receiver.areaVO.treePath)!}" />
									</span>
								</td>
							</tr>
							<tr>
