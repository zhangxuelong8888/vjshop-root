...
<title>${message("shop.member.message.list")}[#if showPowered] - Powered By VJSHOP[/#if]</title>
					...
					<table id="listTable" class="list">
						...
						[#list page.content as memberMessage]
							<tr[#if !memberMessage_has_next] class="last"[/#if]>
								...
								<td>
									[#if memberMessage.receiver == member.getId()]
										[#if memberMessage.sender??]${memberMessage.senders.username}[#else]${message("shop.member.message.admin")}[/#if]
									[#else]
										[#if memberMessage.receiver??]${memberMessage.receivers.username}[#else]${message("shop.member.message.admin")}[/#if]
									[/#if]
								</td>
								<td>
									[#if memberMessage.receiver == member.getId()]
