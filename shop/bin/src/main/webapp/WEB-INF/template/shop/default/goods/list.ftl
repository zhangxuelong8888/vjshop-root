...
[#if productCategory??]
	[@seo type = "goodsList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if showPowered] - Powered By VJSHOP[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.goods.title")}[#if showPowered] - Powered By VJSHOP[/#if]</title>
	<meta name="author" content="VJSHOP Team" />
	<meta name="copyright" content="VJSHOP" />
[/#if]
								...
								<div class="content">
									...
									[#list filterAttributes as filterAttribute]
										...
										<dl class="clearfix[#if rows > 3 && !attributeValueMap?keys?seq_contains(filterAttribute)][#assign hasHiddenAttribute = true /] hidden[/#if]">
											...
											[#list filterAttribute.optionsList as option]
												<dd>
