...
<title>${message("shop.friendLink.title")}[#if showPowered] - Powered By VJSHOP[/#if]</title>
...
<link href="${base}/resources/shop/${theme}/css/friend_link.css" rel="stylesheet" type="text/css" />
