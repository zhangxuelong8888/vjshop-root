...
public class ReviewController extends BaseController {
	...
	public String edit(Long id, ModelMap model) {
		model.addAttribute("review", reviewService.findDetails(id));
	...
	public String update(Long id, @RequestParam(defaultValue = "false") Boolean isShow, RedirectAttributes redirectAttributes) {
		TReview review = reviewService.find(id);
		if (review == null) {
			return ERROR_VIEW;
		}
	...
	public String list(TReview.Type type, Pageable pageable, ModelMap model) {
		model.addAttribute("type", type);
		model.addAttribute("types", TReview.Type.values());
