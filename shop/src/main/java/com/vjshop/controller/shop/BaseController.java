...
import com.vjshop.DateEditor;
import com.vjshop.Message;
import com.vjshop.Setting;
import com.vjshop.StringEditor;
import com.vjshop.exception.IllegalLicenseException;
import com.vjshop.exception.ResourceNotFoundException;
import com.vjshop.template.directive.FlashMessageDirective;
...
public class BaseController {
	 ...
	 */
	@ExceptionHandler
	public ModelAndView exceptionHandler(Exception exception, HttpServletResponse response, HttpServletRequest request) {
...
//				response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
				...
				data.put("message", Message.error("shop.message.error"));
				ModelAndView modelAndView = new ModelAndView();
				modelAndView.getModelMap().putAll(data);
