package com.vjshop.plugin.alipayDualPayment;
...
public class AlipayDualPaymentController extends BaseController {
	...
	@Resource(name = "alipayDualPaymentPlugin")
	...
	public String setting(ModelMap model) {
		TPluginConfig pluginConfig = alipayDualPaymentPlugin.getPluginConfig();
		model.addAttribute("feeTypes", PaymentPlugin.FeeType.values());
		model.addAttribute("pluginConfig", pluginConfig);
		return "/com/vjshop/plugin/alipayDualPayment/setting";
	}
