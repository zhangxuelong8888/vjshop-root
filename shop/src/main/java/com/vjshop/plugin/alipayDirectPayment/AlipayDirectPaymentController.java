...
package com.vjshop.plugin.alipayDirectPayment;
...
public class AlipayDirectPaymentController extends BaseController {
	...
	public String setting(ModelMap model) {
		TPluginConfig pluginConfig = alipayDirectPaymentPlugin.getPluginConfig();
		model.addAttribute("feeTypes", PaymentPlugin.FeeType.values());
		model.addAttribute("pluginConfig", pluginConfig);
		return "/com/vjshop/plugin/alipayDirectPayment/setting";
	}
