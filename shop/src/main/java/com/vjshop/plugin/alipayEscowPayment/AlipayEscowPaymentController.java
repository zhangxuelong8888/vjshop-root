package com.vjshop.plugin.alipayEscowPayment;
...
public class AlipayEscowPaymentController extends BaseController {
	...
	public String setting(ModelMap model) {
		TPluginConfig pluginConfig = alipayEscowPaymentPlugin.getPluginConfig();
		model.addAttribute("feeTypes", PaymentPlugin.FeeType.values());
		model.addAttribute("pluginConfig", pluginConfig);
		return "/com/vjshop/plugin/alipayEscowPayment/setting";
	}
