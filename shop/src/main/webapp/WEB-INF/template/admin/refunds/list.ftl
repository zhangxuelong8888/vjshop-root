...
<title>${message("admin.refunds.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.refunds.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "sn"] class="current"[/#if] val="sn">${message("Refunds.sn")}</li>
					<li[#if page.searchProperty == "account"] class="current"[/#if] val="account">${message("Refunds.account")}</li>
					<li[#if page.searchProperty == "payee"] class="current"[/#if] val="payee">${message("Refunds.payee")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="order">${message("Refunds.order")}</a>
				</th>
				<th>
