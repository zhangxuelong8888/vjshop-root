...
<title>${message("admin.ad.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.ad.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as ad]
				<tr>
					...
					<td>
						${ad.adPositionInfo.name}
					</td>
					<td>
						${message("Ad.Type." + ad.enumType)}
					</td>
					<td>
						[#if ad.beginDate??]
