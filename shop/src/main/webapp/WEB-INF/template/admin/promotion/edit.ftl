...
<title>${message("admin.promotion.edit")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${promotion.orders}" maxlength="9" />
				</td>
			</tr>
			<tr class="memberRank">
				<th>
				...
				<td>
					[#list memberRanks as memberRank]
						<label>
							<input type="checkbox" name="memberRankIds" value="${memberRank.id}"[#if promotion.hasMemberRank(memberRank.id)] checked="checked"[/#if] />${memberRank.name}
						</label>
					[/#list]
				</td>
			</tr>
			<tr class="coupon">
				...
				<td>
					[#list coupons as coupon]
						<label>
							<input type="checkbox" name="couponIds" value="${coupon.id}"[#if promotion.hasCoupon(coupon.id)] checked="checked"[/#if] />${coupon.name}
						</label>
					[/#list]
				</td>
			</tr>
