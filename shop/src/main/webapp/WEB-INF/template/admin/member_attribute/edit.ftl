...
<title>${message("admin.memberAttribute.edit")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.memberAttribute.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					${message("MemberAttribute.Type." + memberAttribute.enumType)}
				</td>
			</tr>
			<tr>
				<th>
			...
			[#if memberAttribute.enumType != "select" && memberAttribute.enumType != "checkbox"]
				<tr>
					<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${memberAttribute.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
			...
			[#if memberAttribute.enumType?? && (memberAttribute.enumType == "select" || memberAttribute.enumType == "checkbox")]
				<tr>
					<th>
						&nbsp;
					</th>
