...
<title>${message("admin.template.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.template.list")}
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list templateConfigs as templateConfig]
				<tr>
					...
					<td>
						<a href="edit.jhtml?id=${templateConfig.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
