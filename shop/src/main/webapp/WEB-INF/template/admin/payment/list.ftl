...
<title>${message("admin.payment.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.payment.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "sn"] class="current"[/#if] val="sn">${message("Payment.sn")}</li>
					<li[#if page.searchProperty == "account"] class="current"[/#if] val="account">${message("Payment.account")}</li>
					<li[#if page.searchProperty == "payer"] class="current"[/#if] val="payer">${message("Payment.payer")}</li>
				</ul>
			</div>
		</div>
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="fee">${message("Payment.fee")}</a>
				</th>
				<th>
			...
			[#list page.content as payment]
				<tr>
					...
					<td>
						${message("Payment.Method." + paymentMethods[payment.method])}
					</td>
					<td>
