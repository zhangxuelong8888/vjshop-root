...
<title>${message("admin.review.edit")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<a href="${review.goodsInfo.url}" target="_blank">${review.goodsInfo.name}</a>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					[#if review.memberInfo??]
						<a href="../member/view.jhtml?id=${review.memberInfo.id}">${review.memberInfo.username}</a>
					[#else]
