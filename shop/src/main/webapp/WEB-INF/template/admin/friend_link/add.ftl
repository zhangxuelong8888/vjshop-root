...
<title>${message("admin.friendLink.add")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.friendLink.add")}
	</div>
			...
			<tr>
				...
				<td>
					<select id="type" name="type">
						[#list types as type]
							<option value="${type.ordinal()}">${message("FriendLink.Type." + type)}</option>
						[/#list]
					</select>
				</td>
			</tr>
