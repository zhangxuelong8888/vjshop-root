...
<title>${message("admin.paymentMethod.edit")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.paymentMethod.edit")}
	</div>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<select name="type">
						[#list types as type]
							<option value="${type.ordinal()}"[#if type.ordinal() == paymentMethod.type] selected="selected"[/#if]>${message("PaymentMethod.Type." + type)}</option>
						[/#list]
					</select>
				</td>
			</tr>
				...
				<td>
					<select name="method">
						[#list methods as method]
							<option value="${method.ordinal()}"[#if method.ordinal() == paymentMethod.method] selected="selected"[/#if]>${message("PaymentMethod.Method." + method)}</option>
						[/#list]
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${paymentMethod.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
