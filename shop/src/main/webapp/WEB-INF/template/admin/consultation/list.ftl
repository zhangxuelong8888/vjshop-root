...
<title>${message("admin.consultation.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.consultation.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as consultation]
				<tr>
					...
					<td>
						<a href="${consultation.goodsInfo.url}" title="${consultation.goodsInfo.name}" target="_blank">${abbreviate(consultation.goodsInfo.name, 50, "...")}</a>
					</td>
					<td>
