...
<title>${message("admin.member.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.member.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					...
					<li[#if page.searchProperty == "nickname"] class="current"[/#if] val="nickname">${message("Member.nickname")}</li>
				</ul>
			</div>
		</div>
