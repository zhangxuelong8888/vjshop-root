...
<title>${message("admin.article.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.article.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
				...
				<tr>
					...
					<td>
						...
						[#if article.isPublication]
							<a href="${article.url}" target="_blank">[${message("admin.common.view")}]</a>
						[#else]
