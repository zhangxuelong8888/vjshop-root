...
<title>${message("admin.messageConfig.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.messageConfig.list")}
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table class="list">
			...
			[#list messageConfigs as messageConfig]
				<tr>
					<td>
						${message("MessageConfig.Type." + messageConfig.typeName())}
					</td>
					<td>
					...
					<td>
						<a href="edit.jhtml?id=${messageConfig.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
