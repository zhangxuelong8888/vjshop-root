...
<title>${message("admin.articleCategory.list")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.articleCategory.list")}
	</div>
	<div class="bar">
