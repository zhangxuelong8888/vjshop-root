...
<title>${message("admin.specification.add")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.specification.add")}
	</div>
			...
			<tr>
				...
				<td>
					<table id="optionTable" class="item">
						...
						[#if sample??]
							[#list sample.optionsList as option]
								<tr>
									<td>
