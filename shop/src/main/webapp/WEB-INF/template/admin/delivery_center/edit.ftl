...
<title>${message("admin.deliveryCenter.edit")} - Powered By VJSHOP</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="hidden" id="areaId" name="areaId" value="${(deliveryCenter.areaVO.id)!}" treePath="${(deliveryCenter.areaVO.treePath)!}" />
					</span>
				</td>
			</tr>
			<tr>
