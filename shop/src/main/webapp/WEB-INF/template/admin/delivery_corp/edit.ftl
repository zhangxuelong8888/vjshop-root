...
<title>${message("admin.deliveryCorp.edit")} - Powered By VJSHOP</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.deliveryCorp.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${deliveryCorp.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
