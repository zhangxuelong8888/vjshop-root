...
<title>${message("admin.attribute.edit")} - Powered By VJSHOP</title>
	...
	$addOptionButton.click(function() {
		$optionTable.append(
			[@compress single_line = true]
				'<tr>
					<td>
						<input type="text" name="optionsList" class="text" maxlength="200" \/>
					<\/td>
					<td>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.attribute.edit")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					${attribute.productCategoryVO.name}
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="orders" class="text" value="${attribute.orders}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<table id="optionTable" class="item">
						...
						[#list attribute.optionsList as option]
							<tr>
								<td>
									<input type="text" name="optionsList" class="text" value="${option}" maxlength="200" />
								</td>
								<td>
									<a href="javascript:;" class="remove">[${message("admin.common.remove")}]</a>
								</td>
